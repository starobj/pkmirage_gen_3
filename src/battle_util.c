...
const struct TypePower gNaturalGiftTable[] =
{
    ...
    [ITEM_TO_BERRY(ITEM_APPLE)] = {TYPE_FAIRY, 80},
    [ITEM_TO_BERRY(ITEM_GINSENG)] = {TYPE_FIRE, 90},
    ...
    [ITEM_TO_BERRY(ITEM_ENERGY_ROOT)] = {TYPE_STEEL, 100},
    [ITEM_TO_BERRY(ITEM_REVIVAL_HERB)] = {TYPE_FAIRY, 100},
};
