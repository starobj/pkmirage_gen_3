...
static const struct TilesPal sBerryPicTable[] =
{
    ...
    [ITEM_TO_BERRY(ITEM_GINSENG)   - 1]          = {gBerryPic_Bluk,   gBerryPalette_Bluk},
    ...
    [ITEM_TO_BERRY(ITEM_APPLE)        - 1]          = {gBerryPic_Roseli, gBerryPalette_Roseli},
    ...
    [ITEM_TO_BERRY(ITEM_ENERGY_ROOT)  - 1]          = {gBerryPic_Kee, gBerryPalette_Kee},
    [ITEM_TO_BERRY(ITEM_REVIVAL_HERB) - 1]          = {gBerryPic_Maranga, gBerryPalette_Maranga},
