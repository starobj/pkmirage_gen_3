...
const struct SpriteFrameImage *const gBerryTreePicTablePointers[] = {
    ...
    [ITEM_GINSENG - FIRST_BERRY_INDEX]                = sPicTable_OccaBerryTree,
    ...
    [ITEM_APPLE - FIRST_BERRY_INDEX]                  = sPicTable_CheriBerryTree,
    ...
    [ITEM_ENERGY_ROOT - FIRST_BERRY_INDEX]            = sPicTable_WepearBerryTree,
    [ITEM_REVIVAL_HERB - FIRST_BERRY_INDEX]           = sPicTable_KasibBerryTree,
...
const u8 *const gBerryTreePaletteSlotTablePointers[] = {
    ...
    [ITEM_GINSENG - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Occa,
    ...
    [ITEM_APPLE - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Cheri,
    ...
    [ITEM_ENERGY_ROOT - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Kasib,
    [ITEM_REVIVAL_HERB - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Durin,
