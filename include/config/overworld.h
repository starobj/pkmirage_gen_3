...
#define OW_PC_RELEASE_ITEM          GEN_8      // In Gen8+, Pokémon that get released with a held item return it to the bag.
...
// Trainer Rematches
#define OW_REMATCH_BADGE_COUNT      0 // Number of badges necessary before the match call or vs seeker features allow rematches
