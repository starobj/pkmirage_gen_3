...
// Flag/var defines
#define DN_FLAG_SEARCHING             (1 << 0) // Searching for mon
#define DN_FLAG_DEXNAV_GET            (1 << 1) // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         (1 << 2) // Allow player to find hidden mons
