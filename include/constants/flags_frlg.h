...
#define FLAG_HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_GINSENG              (FLAG_HIDDEN_ITEMS_START +  91)
...
#define FLAG_HIDDEN_ITEM_ROUTE25_GINSENG                                (FLAG_HIDDEN_ITEMS_START + 117)
...
#define FLAG_HIDDEN_ITEM_FIVE_ISLAND_MEMORIAL_PILLAR_GINSENG            (FLAG_HIDDEN_ITEMS_START + 173)
