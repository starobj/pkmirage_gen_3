...
enum __attribute__((packed)) Item
{
    ...
    ITEM_SHROOM_POWDER = 40,
    ITEM_SHROOMPOWDER = ITEM_SHROOM_POWDER, // Pre-Gen VI name
    ITEM_HEAL_POWDER = 41,
    ITEM_NORI_POWDER = 42,
    ITEM_ANTIDOTE = 43,
    ...
    ITEM_BLUE_GUMMY = 239,
    ITEM_PINK_GUMMY = 240,
    ITEM_GREEN_GUMMY = 241,
    ITEM_YELLOW_GUMMY = 242,
    ITEM_PURPLE_GUMMY = 243,
    ITEM_ORANGE_GUMMY = 244,
    ...
    ITEM_ENERGY_ROOT = 579,
    ITEM_REVIVAL_HERB = 580,
    ITEM_ENIGMA_BERRY_E_READER = 581,
    LAST_BERRY_INDEX =  ITEM_ENIGMA_BERRY_E_READER,

    BERRIES_COUNT = 1 + LAST_BERRY_INDEX - FIRST_BERRY_INDEX,
    ...
    // Foods
    FIRST_FOOD_INDEX = 874,
    ITEM_POKE_FOOD = FIRST_FOOD_INDEX,
    ITEM_MUFFIN = 875,
    ITEM_PASTRY = 876,
    ITEM_CUSTARD = 877,
    ITEM_CUPCAKE = 878,
    ITEM_ADZUKI_MOCHI = 879,
    ITEM_MATCHA_MOCHI = 880,
    ITEM_MYSTERY_MOCHI = 881,
    ITEM_RAW_HONEY = 882,
    ITEM_GREEN_TEA = 883,
    ITEM_SITRUS_JUICE = 884,
    LAST_FOOD_INDEX = ITEM_SITRUS_JUICE,

    // Outfits
    // FIRST_OUTFIT_INDEX = 890,
    // ITEM_OUTFIT_ACE_TRAINER = FIRST_OUTFIT_INDEX,
    // ITEM_OUTFIT_RANGER = 891,
    // ITEM_OUTFIT_RICH = 892,
    // ITEM_OUTFIT_SWIMMER = 893,
    // ITEM_OUTFIT_TRIATHLETE = 894,
    // ITEM_OUTFIT_TUBER = 895,
    // ITEM_OUTFIT_ROCKET = 896,
    // ITEM_OUTFIT_MAGMA = 897,
    // ITEM_OUTFIT_AQUA = 898,
    // ITEM_OUTFIT_CHAMPION = 899,
    // LAST_OUTFIT_INDEX = ITEM_OUTFIT_CHAMPION,
