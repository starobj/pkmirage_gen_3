...
#define ITEM1_X_EVASION         STAT_EVASION


#define ITEM1_X2_ATTACK         ITEM1_X_EVASION + STAT_ATK
#define ITEM1_X2_DEFENSE        ITEM1_X_EVASION + STAT_DEF
#define ITEM1_X2_SPEED          ITEM1_X_EVASION + STAT_SPEED
#define ITEM1_X2_SPATK          ITEM1_X_EVASION + STAT_SPATK
#define ITEM1_X2_SPDEF          ITEM1_X_EVASION + STAT_SPDEF
#define ITEM1_X2_ACCURACY       ITEM1_X_EVASION + STAT_ACC
#define ITEM1_X2_EVASION        ITEM1_X_EVASION + STAT_EVASION


#define ITEM1_AUX_EVASION       ITEM1_X2_EVASION + 0x1
#define ITEM1_AUX_GUARD         ITEM1_X2_EVASION + 0x2
#define ITEM1_AUX_POWER         ITEM1_X2_EVASION + 0x3
#define ITEM1_AUX_POWERGUARD    ITEM1_X2_EVASION + 0x4

#define ITEM1_FERTILITY         ITEM1_AUX_POWERGUARD + 0x1
